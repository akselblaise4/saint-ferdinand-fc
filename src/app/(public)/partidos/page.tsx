...
export default function PartidosPage() {
  ...
  const photoForTeam = (teamId: string) => standings.find((s) => s.id === teamId)?.photo ?? undefined;
            ...
            <>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0">
                ...
                <div className="flex flex-col items-center flex-1">
                  ...
                  <h2 className="font-display-lg text-display-lg text-surface uppercase tracking-tighter">
              ...
              <div className="mt-12 flex justify-center gap-6">
                ...
                <button className="bg-transparent border-2 border-surface text-surface font-label-lg uppercase px-12 py-4 tracking-widest hover:bg-surface hover:text-on-surface transition-all">
                  Preview
                </button>
              </div>
            </>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div>
              ...
              <p className="text-on-surface-variant font-body-lg text-body-lg">
                {regularMatches.length} partidos en fase regular
              </p>
            </div>
                ...
                <button
                  ...
                  className={`px-6 py-2 font-label-sm uppercase tracking-wider transition-colors ${
                    filter === f.key
                      ...
                      : "bg-surface border border-secondary-container text-on-surface-variant hover:border-primary"
                  }`}
                >
                  {f.label}
                </button>
          ...
          <div className="space-y-4">
            {displayedMatches.length === 0 ? (
              <p className="text-center py-16 font-body-lg text-body-lg text-on-surface-variant">
                No hay partidos{filter ? ` con filtro "${filter}"` : ""}
              </p>
            ) : (
              displayedMatches.map((m) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-surface-container-lowest border border-surface-container-high group hover:border-primary transition-colors"
                  >
                    <div className="flex flex-col md:flex-row items-center p-6 md:p-8 gap-6">
                      ...
                      <div className="w-full md:w-56 flex justify-end gap-3 shrink-0">
                        <Link
                          href="/copa"
                          className="flex-1 md:flex-none bg-surface-container-high text-on-surface font-label-sm uppercase py-3 px-5 text-center hover:bg-primary hover:text-on-primary transition-all tracking-wider"
                        >
                          Detalles
                        </Link>
                        <button className="p-3 bg-surface border border-secondary-container hover:border-primary transition-colors">
        ...
        <div className="max-w-desktop mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-start">
            ...
            <div className="md:col-span-4 space-y-6">
              ...
              <Link
                href="/copa"
                className="w-full block text-center py-4 bg-surface border border-secondary-container font-label-lg uppercase tracking-widest hover:bg-on-surface hover:text-surface transition-all"
              >
                Ver Todos
              </Link>
            </div>
